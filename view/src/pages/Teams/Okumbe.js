      ...
      <div className="row">
        ...
        <div className="col-12 col-md-12 px-5 text-center h-100">
          ...
          >
            ...
            <h5 className="text-primary">(FRICS, PrQS, RQS, PMAQS)</h5>
            <hr className="hr"></hr>
          </div>
          ...
          <div className="container mt-4">
            <div data-aos="fade-up" data-aos-duration="500">
              <p>
                ...
                over 20 years of hands-on experience, Dr. Okumbe brings a wealth
            ...
            <div data-aos="fade-up" data-aos-duration="500">
              <p>
                ...
                prestigious professional organizations like the Royal
